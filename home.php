...
<head>
    ...
    <title>Επιστημονικά Περιοδικά για την Υγεία</title>
...
<body class="bg-light">
    ...
    <!-- Ενσωματώνουμε τον κώδικα JavaScript για το Autocomplete -->
    <script>
        $(function() {
            // Ορίζουμε τις διαθέσιμες επιλογές
            var availableCategories = [
                "Pharmacy",
                "Health",
                "Hospital"
            ];
            // Εφαρμόζουμε το autocomplete στο πεδίο εισαγωγής με id "categoryInput"
